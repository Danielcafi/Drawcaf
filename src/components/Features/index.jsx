...
export default function Features() {
  const dataFeatures = [
    ...
    },
    {
      ...
      logo: "/feature-2.svg",
      content:
        "You own your data, store design and business plan, but you are free to use the software platform and resources provided by Drawcaf.",
    },
    {
      id: 3,
      ...
      logo: "/feature-3.svg",
      content:
        "Drawcaf is so dedicated to keeping its software current that it sends you free updates for a lifetime without charging you anything.",
    },
    {
      id: 4,
